...
def prepare_web_data() -> None:
    ...
    print(f"Exported {len(courses_list)} courses to {courses_out}")
    ...
    print(f"Exported {len(records)} records with course links to {json_out} ({json_out.stat().st_size / 1024:.1f} KB)")
